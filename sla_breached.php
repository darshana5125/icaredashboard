...
<option value="sla_breached" selected>SLA Breached</option>
</select>
...
<input type="hidden" id="min" /><br>
<input type="hidden" id="max" />
<input type="hidden" id="minh" /><br>
<input type="hidden" id="maxh" />
<input type="hidden" id="minc" /><br>
<input type="hidden" id="maxc" />';
...
and issue_view.queue_id not in(7,13) and issuehis_view.history_type_id=27 and  servicelevel_view.sla_state=3
...
//{			
			...
			<th>Create Time</th><th>Priority</th><th>Total Age </th><th>Adjustments</th><th>Actual Age(hrs)</th><th>Actual Age</th>
			<th>1st Ecs</th><th>2nd Esc</th></tr></thead>
			<tfoot><tr><th></th><th>Queue ID</th><th>CSR #</th><th>Owner</th><th>Status</th><th>Description</th>
			<th>Create Time</th><th>Priority</th><th>Total_Age </th><th>Adjustments</th><th>Actual Age(hrs)</th><th>Actual_Age</th>
	...
	while($result2=mysqli_fetch_assoc($query_rows_run))
	{
		...
		where issue_view.create_time>'2014-11-10 00:00:00' and issuehis_view.history_type_id=27
		and issue_view.queue_id not in(7,13) and
...
$ticket_id="";				
	...
	while($result=mysqli_fetch_assoc($query_run))
		...
		<td><input type="hidden" name="row['.$rownum.'][1]" value="'.$cx_id.'" />'.$cx_id.'</td>
		  <td><input type="hidden" name="row['.$rownum.'][2]" value="'.$ticket_no.'" /><a href="http://icare.interblocks.com/otrs/index.pl?Action=AgentTicketZoom;TicketID='.$ticket_id.'"  target="_blank"  rel = "noopener noreferrer">'.$ticket_no.'</a></td>
		 ...
		 <td><input type="hidden" name="row['.$rownum.'][5]" value="'.$title.'" />'.$title.'</td>
		 ...
		 <td ><input type="hidden" name="row['.$rownum.'][10]" value="'.round($Acual_age,1).' hrs" />'.round($Acual_age,1). '</td>
...
//}
 ...
 function loadtext() {
    if (document.getElementById('range').value == '1st'){
        document.getElementById('min').value = '36';
		 document.getElementById('max').value = '60';
		 
		 document.getElementById('minh').value = '1.5';
		 document.getElementById('maxh').value = '3';
		 
		  document.getElementById('minc').value = '0.5';
		 document.getElementById('maxc').value = '1';
		 
		
		
    }
	else  if (document.getElementById('range').value == '2nd'){
        document.getElementById('min').value = '84';
		 document.getElementById('max').value = '100';
		 
		 document.getElementById('minh').value = '3.5';
		 document.getElementById('maxh').value = '5.5';
		 
		  document.getElementById('minc').value = '1';
		 document.getElementById('maxc').value = '1.5';
		 
		 
    }
		else  if (document.getElementById('range').value == '2nd_passed'){
        document.getElementById('min').value = '100';
		 document.getElementById('max').value = '120';
		 
		 document.getElementById('minh').value = '5.6';
		 document.getElementById('maxh').value = '8';
		 
		  document.getElementById('minc').value = '1.5';
		 document.getElementById('maxc').value = '2';
		 
		
    }
	else if (document.getElementById('range').value == 'breached'){
        document.getElementById('min').value = '120';
		 document.getElementById('max').value = '50000';
		 
		  document.getElementById('minh').value = '8';
		 document.getElementById('maxh').value = '50000';
		 
		  document.getElementById('minc').value = '2';
		 document.getElementById('maxc').value = '50000';
		...
		document.getElementById('min').value = '0';
		 document.getElementById('max').value = '50000';
		  ...
		  document.getElementById('minh').value = '0';
		 document.getElementById('maxh').value = '50000';
