              ...
              substring_index(substring_index((select name as name
                  ...
                  on h.ticket_id=ti.id  
                    ...
                    inner join users u1 on t.responsible_user_id=u1.id
                      ...
                      and t.customer_id not in($cx_list) and t.queue_id not in($q_list) and t.create_time<='2018-01-31' and t.create_time>='2014-11-10'
                      group by ser_id
                      order by count desc";
    ...
    $query_current_ibl="select count(th.ticket_id) as count,substring_index(substring_index((select name as name
                          ...
                          from ticket_history
                            ...
                            and date(x.change_time) <=  ".$date." and date(x.change_time) >= '2014-11-10' 
                                        ...
                                        t.customer_id not in($cx_list) and t.queue_id not in($q_list) and t.create_time<='2018-01-31'
                                       	and t.create_time>='2014-11-10'";
             ...
             substring_index(substring_index((select name as name
                  ...
                  on h.ticket_id=ti.id  
                    ...
                    inner join users u on t.user_id=u.id
                      where th.state_id  in (1,4,12,20,23,26,27,28,29,31,32,13,14,30,33) 
                      and t.customer_id not in($cx_list) and t.queue_id not in($q_list) and t.create_time<='2018-01-31'
					  and t.create_time>='2014-11-10'
                      order by s2.name";
...
<header>
  ...
  <form name="hod" method="POST" action="hod_backlog.php">
    ...
    Select Date:
		...
		<h4 style=" margin: 0 150 auto;">Backlog by Product </h4>
    </div>
...
//alert(test2);
 ...
 data.addRows([[hod, count]]);
        ...
        // Set chart options
        var options = {'title':'Backlog IBL Pending by Product',
                       'width':700,
                       'height':700};
...
//alert(test2);
 ...
 data.addRows([[hod, count]]);
        ...
        // Set chart options
        var options = {'title':'Backlog Effective CSR by Product',
                       'width':700,
                       'height':700};
