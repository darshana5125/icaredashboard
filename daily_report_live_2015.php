...
$query="select distinct * from temp2_view where create_time between '2015-04-01' and  '2016-04-01' and exception=0 and q_name!='Change Request Queue' and q_name  !='NDB - Live Issues'
 and q_name!='DELETED_TICKETS' and q_name!='Vattanac CR Queue'
union(
