                ...
                and date(x.change_time) < DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY) and date(x.change_time) >= '2014-11-10' 
                  ...
                  on h.ticket_id=ti.id  
                    ...
                    inner join users u1 on t.responsible_user_id=u1.id
                      where th.state_id  in (1,4,12,20,23,26,27,28,29,31,32,14,30,13,33) and t.customer_id not in('phl-ubp') and t.queue_id not in(41) and substring_index((select name as name
                                      from ticket_history
                                        where id = (
                                        select max(id) from ticket_history x where history_type_id = 34 and ticket_id = th.ticket_id
                                        and date(x.change_time) < DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY) and date(x.change_time) >= '2014-11-10' 
              ...
              from ticket_history
                ...
                and date(x.change_time) < DATE_SUB(DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY),INTERVAL 1 WEEK) and date(x.change_time) >= '2014-11-10' 
                  ...
                  on h.ticket_id=ti.id  
                    ...
                    inner join ticket t on t.id = th.ticket_id
                    inner join users u1 on t.responsible_user_id=u1.id
                      where th.state_id  in (1,4,12,20,23,26,27,28,29,31,32,14,30,13,33) and t.customer_id not in('phl-ubp') and t.queue_id not in(41) and
              ...
              from ticket_history
                ...
                and date(x.change_time) < DATE_SUB(DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY),INTERVAL 1 WEEK) and date(x.change_time) >= '2014-11-10' 
                  ...
                  on h.ticket_id=ti.id  
                    ...
                    inner join ticket t on t.id = th.ticket_id
                    inner join users u1 on t.responsible_user_id=u1.id
                      where th.state_id  in (1,4,12,20,23,26,27,28,29,31,32,14,30,13,33) and t.customer_id not in('phl-ubp','$customers') and
                     substring_index((select name as name
                                      from ticket_history
                                        where id = (
                                        select max(id) from ticket_history x where history_type_id = 34 and ticket_id = th.ticket_id
                    ...
                    inner join users u1 on t.responsible_user_id=u1.id
                      where th.state_id  in (1,4,12,20,23,26,27,28,29,31,32,14,30,13,33) and t.customer_id not in('phl-ubp') and t.queue_id not in(41) and substring_index((select name as name
                                      from ticket_history
                                        ...
                                        select max(id) from ticket_history x where history_type_id = 34 and ticket_id = th.ticket_id
                                        and date(x.change_time) < DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY) and date(x.change_time) >= '2014-11-10' 
                                        ) ), '%', -1) in (77,175,141,58,63,165,110,94,20,25,197)
              ...
              from ticket_history
                ...
                and date(x.change_time) < DATE_SUB(DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY),INTERVAL 1 WEEK) and date(x.change_time) >= '2014-11-10' 
                  ...
                  on h.ticket_id=ti.id  
                    ...
                    inner join ticket t on t.id = th.ticket_id
                    inner join users u1 on t.responsible_user_id=u1.id
                      where th.state_id  in (1,4,12,20,23,26,27,28,29,31,32,14,30,13,33) and t.customer_id not in('phl-ubp') and t.queue_id not in(41) ".$sql."  and substring_index((select name as name
                                      from ticket_history
                                        where id = (
                                        select max(id) from ticket_history x where history_type_id = 34 and ticket_id = th.ticket_id
                                        and date(x.change_time) < DATE_SUB(DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY),INTERVAL 1 WEEK) and date(x.change_time) >= '2014-11-10' 
              ...
              from ticket_history
                ...
                and date(x.change_time) < DATE_SUB(DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY),INTERVAL 1 WEEK) and date(x.change_time) >= '2014-11-10' 
                  ...
                  on h.ticket_id=ti.id  
                    ...
                    inner join ticket t on t.id = th.ticket_id
                    inner join users u1 on t.responsible_user_id=u1.id
                      where th.state_id  in (1,4,12,20,23,26,27,28,29,31,32,14,30,13,33) and t.customer_id not in('phl-ubp') and t.queue_id not in(41)and t.customer_id in ('$cx_id')  and substring_index((select name as name
                                      from ticket_history
                                        where id = (
                                        select max(id) from ticket_history x where history_type_id = 34 and ticket_id = th.ticket_id
                                        and date(x.change_time) < DATE_SUB(DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY),INTERVAL 1 WEEK) and date(x.change_time) >= '2014-11-10' 
...
while ($result=mysqli_fetch_array($gayanee_run)) {
    ...
    $change=$count-$gayanee_previous_count;
...
$pubudu="select count(th.ticket_id) as count,t.customer_id, substring_index((select name as name
          from ticket_history
            where id = (
            select max(id) from ticket_history x where history_type_id = 34 and ticket_id = th.ticket_id
            and date(x.change_time) < DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY) and date(x.change_time) >= '2014-11-10' 
                ...
                and date(x.change_time) < DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY) and date(x.change_time) >= '2014-11-10' 
                  ...
                  on h.ticket_id=ti.id  
                    ...
                    inner join users u1 on t.responsible_user_id=u1.id
                      ...
                      order by count desc";
$table_list13="";
$table_list13.='<table class="hodlist"> 
<tr><th class="header"  colspan="4">HOD - Pubudu</th></tr>
<tr><th class="cx">Customer</th><th class="header2">Current Count</th><th class="header2">Previous Count</th><th class="header2">Change</th></tr>';


$pubudu_run=mysqli_query($connection,$pubudu);
//$cxs[]="";

while ($result=mysqli_fetch_array($pubudu_run)) {
	//$sql="";
	$pubudu_previous_count="0";
	$cx_id=$result['customer_id'];
	//if (!in_array($cx_id, $cxs)){
		//$sql="and t.customer_id in ('".$cx_id."')";
		//echo "yes";
	...
	$pubudu_previous="select count(th.ticket_id) as count,t.customer_id, substring_index((select name as name
          from ticket_history
            where id = (
            select max(id) from ticket_history x where history_type_id = 34 and ticket_id = th.ticket_id
            and date(x.change_time) < DATE_SUB(DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY),INTERVAL 1 WEEK) >= '2014-11-10' 
     ...
     $pubudu_previous_run=mysqli_query($connection,$pubudu_previous);
     while($result=mysqli_fetch_array($pubudu_previous_run)){

     	$pubudu_previous_count=$result['count'];
     	$tot_pre+=$pubudu_previous_count;
     	
     }

    $change=$count-$pubudu_previous_count;

    
	$table_list13.='<tr><td>'.$cx_id.'</td><td class="count">'.$count.'</td><td class="prv_count">'.$pubudu_previous_count.'</td><td class="chg_count">'.$change.'</td></tr>';
	$pubudu_previous_count="0";	
	$cx_id="";
...
$customers=ltrim($customers,'\'');
     ...
     $pubudu_previous2="select count(th.ticket_id) as count,t.customer_id, substring_index((select name as name
          from ticket_history
            where id = (
            select max(id) from ticket_history x where history_type_id = 34 and ticket_id = th.ticket_id
            and date(x.change_time) < DATE_SUB(DATE_SUB(DATE(NOW()), INTERVAL DAYOFWEEK(NOW())-2 DAY),INTERVAL 1 WEEK) >= '2014-11-10' 
                  ...
                  on h.ticket_id=ti.id  
                    ...
                    inner join users u1 on t.responsible_user_id=u1.id
                      ...
                      order by count desc";
                       ...
                       $pubudu_previous2_run=mysqli_query($connection,$pubudu_previous2);
     while($result=mysqli_fetch_array($pubudu_previous2_run)){

     	$pubudu_previous_cx=$result['customer_id'];
     	$pr_cx=$result['count'];

     	$table_list13.='<tr><td>'.$pubudu_previous_cx.'</td><td class="count">0</td><td class="prv_count">'.$pr_cx.'</td><td class="chg_count">'.'-'.$pr_cx.'</td></tr>';
     	$tot_pre+=$pr_cx;
     	 

     }
     $tot_chg=$tot_cur-$tot_pre;
     $table_list13.='<tr><td style="font-weight:bold;">Total</td><td style="font-weight:bold;" class="count">'.$tot_cur.'</td><td style="font-weight:bold;" class="prv_count">'.$tot_pre.'</td><td style="font-weight:bold;" class="chg_count">'.$tot_chg.'</td></tr>';
?>
