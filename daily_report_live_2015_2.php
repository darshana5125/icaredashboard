...
$query="select distinct * from view_temp2 where q_name not like '%_UAT%' and create_time>='2019-04-01' and exception=0 and  
q_name not in ('Change Request Queue','NDB - Live Issues','DELETED_TICKETS','CRB_Projects','Change Request_Queue::Vattanac_CR Queue',
