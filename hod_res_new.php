              ...
              from ticket_history
                ...
                and date(x.change_time) <= DATE_SUB(".$date.",INTERVAL 1 WEEK) and date(x.change_time) >= '2018-02-01' 
                  ...
                  on h.ticket_id=ti.id  
                    ...
                    inner join ticket t on t.id = th.ticket_id
                    inner join users u1 on t.responsible_user_id=u1.id
                      where th.state_id  in (1,4,12,20,23,26,27,28,29,31,32,13,14,30,33) and  t.customer_id not in($cx_list) and t.queue_id not in($q_list) and t.create_time>='2018-02-01'
                      group by res_name
                      order by count desc";
                                  ...
                                  on h.ticket_id=ti.id  
                                    ...
                                    inner join users u1 on t.responsible_user_id=u1.id
                                      ...
                                      from ticket_history
                                        ...
                                        th.state_id  in ('1','4','12','20','23','26','27','28','29','32') and  t.customer_id not in($cx_list) and t.queue_id not in($q_list)
                                  ...
                                  on h.ticket_id=ti.id  
                                    ...
                                    inner join users u1 on t.responsible_user_id=u1.id
                                      ...
                                      from ticket_history
                                        ...
                                        th.state_id  in (14,30,31) and   t.customer_id not in($cx_list) and t.queue_id not in($q_list)
                                        and t.create_time>='2018-02-01'";
                                  ...
                                  on h.ticket_id=ti.id  
                                    ...
                                    inner join users u1 on t.responsible_user_id=u1.id
                                      ...
                                      from ticket_history
                                        ...
                                        th.state_id  in ('13') and   t.customer_id not in($cx_list) and t.queue_id not in($q_list)
                                        and t.create_time>='2018-02-01'";
                                  ...
                                  on h.ticket_id=ti.id  
                                    ...
                                    inner join users u1 on t.responsible_user_id=u1.id
                                      ...
                                      from ticket_history
                                        ...
                                        th.state_id  in ('33') and   t.customer_id not in($cx_list) and t.queue_id not in($q_list)
                                        and t.create_time>='2018-02-01'";
...
<header>
  ...
  <form name="hod" method="POST" action="hod_res_new.php">
    ...
    Select Date:
		...
		<h4 style=" margin: 0 150 auto;">Ongoing by Responsible</h4>
    </div>
...
//alert(test2);
 ...
 data.addRows([[hod, count]]);
        ...
        // Set chart options
        var options = {'title':'Ongoing IBL Pending by Responsible',
                       'width':700,
                       'height':700};
...
//alert(test2);
 ...
 data.addRows([[hod, count]]);
        ...
        // Set chart options
        var options = {'title':'Ongoing Effective by Responsible',
                       'width':700,
                       'height':700};
...
//alert(test2);
 ...
 data.addRows([[hod, count]]);
        ...
        // Set chart options
        var options = {'title':'Ongoing PM CSR by Responsible',
                       'width':600,
                       'height':500};
