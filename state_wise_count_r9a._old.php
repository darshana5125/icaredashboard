...
<header>
		...
		<div class="loggedin">Welcome1 <?php echo ucfirst($_SESSION['first_name']); ?>! <a href="ums/logout.php">Log Out</a></div>
</header>
...
where th.state_id not in ('24','25','5','10','17','16','7') and t.customer_id in($cx) and t.responsible_user_id in($res) and t.customer_id not in('phl-ubp','swe-win')
...
inner join service s on s.id=t.service_id
inner join users u1 on t.responsible_user_id=u1.id
where th.state_id not in ('24','25','5','10','17','16','7') and t.customer_id in($cx) and t.customer_id not in('phl-ubp','swe-win')
order by th.ticket_id desc";
...
inner join service s on s.id=t.service_id
inner join users u1 on t.responsible_user_id=u1.id
where th.state_id not in ('24','25','5','10','17','16','7') and t.responsible_user_id in($res) and t.customer_id not in('phl-ubp','swe-win')
order by th.ticket_id desc";
...
inner join service s on s.id=t.service_id
inner join users u1 on t.responsible_user_id=u1.id
where th.state_id not in ('24','25','5','10','17','16','7') and t.customer_id not in('phl-ubp','swe-win')
order by th.ticket_id desc";	
...
inner join users u on u.id = th.owner_id
where  th.state_id in( '24','25','10','17','7','16') and  t.customer_id in($cx) and t.responsible_user_id in($res) and t.customer_id not in('phl-ubp','swe-win')and th.state_id not in( '5') and th.ticket_id in (
	select th.ticket_id
	from ticket_history th 
	inner join (
...
inner join users u on u.id = th.owner_id
where  th.state_id in( '24','25','10','17','7','16') and  t.customer_id in($cx) and t.customer_id not in('phl-ubp','swe-win')and th.state_id not in( '5') and th.ticket_id in (
	select th.ticket_id
	from ticket_history th 
	inner join (
		select min(h.id) as max_hist, h.ticket_id
...
inner join users u on u.id = th.owner_id
where  th.state_id in( '24','25','10','17','7','16') and  t.responsible_user_id in($res) and t.customer_id not in('phl-ubp','swe-win')and th.state_id not in( '5') and th.ticket_id in (
	select th.ticket_id
	from ticket_history th 
	inner join (
		select min(h.id) as max_hist, h.ticket_id
...
inner join users u on u.id = th.owner_id
where  th.state_id in( '24','25','10','17','7','16') and t.customer_id not in('phl-ubp','swe-win')and th.state_id not in( '5') and th.ticket_id in (
	select th.ticket_id
	from ticket_history th 
	inner join (
		select min(h.id) as max_hist, h.ticket_id
...
t.create_time>='$from' and t.customer_id in($cx) and t.responsible_user_id in($res) and t.customer_id not in('phl-ubp','swe-win')";
...
inner join users u1 on t.responsible_user_id=u1.id
where date(t.create_time)<='$to' and 
t.create_time>='$from' and t.customer_id in($cx) and t.customer_id not in('phl-ubp','swe-win')";
...
inner join users u1 on t.responsible_user_id=u1.id
where date(t.create_time)<='$to' and 
t.create_time>='$from' and t.responsible_user_id in($res) and t.customer_id not in('phl-ubp','swe-win')";	
...
inner join users u1 on t.responsible_user_id=u1.id
where date(t.create_time)<='$to' and 
t.create_time>='$from' and t.customer_id not in('phl-ubp','swe-win')";
...
inner join ticket t on t.id = th.ticket_id
inner join ticket_state ts on ts.id = th.state_id
where th.state_id in ('24','25','17','7','16') and  t.customer_id not in('phl-ubp','swe-win') and
...
and t.customer_id not in('phl-ubp','swe-win') and th.ticket_id=$ticket_id
order by th.ticket_id desc";
...
t.customer_id not in('phl-ubp','swe-win') and th.ticket_id=$ticket_id
order by th.ticket_id desc";
$bf_fix_run=mysqli_query($connection,$bf_fix);
