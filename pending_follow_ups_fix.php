...
<div class="container">
<form method="POST" action="pending_follow_ups_fix.php?mid=17" name="form1" id="form1" >
<div class="dropdown">
...
on a.ticket_id=t.id 
inner join service_view ts
on ts.id=t.ticket_state_id
inner join service_view s
on s.id=t.service_id
where t.ticket_state_id in(7,24,25,5,10)  and t.create_time>'2014-11-10' and 
...
inner join service_view s
on s.id=t.service_id
where t.ticket_state_id in(7,24,25,15,10)  and t.create_time>'2014-11-10' and 
