...
<head>
	...
	<link rel="stylesheet" type="text/css" href="libraries/cloudflare/ajax/libs/materialize/0.97.6/css/materialize.min.css">
	
	<!--link rel="stylesheet" type="text/css" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css"-->
	<link rel="stylesheet" type="text/css" href="libraries/ionicframework/ionicons/2.0.1/css/ionicons.min.css">
	
	
	<!--link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css"-->
	<link rel="stylesheet" type="text/css" href="libraries/bootstrapcdn/bootstrap/3.3.5/css/bootstrap.min.css">
	
	<!--script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.0.0/jquery.min.js"></script-->
	<script src="libraries/cloudflare/ajax/libs/jquery/3.0.0/jquery.min.js"></script>	
	
	<!--script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.7/js/materialize.min.js"></script-->
	<script src="libraries/cloudflare/ajax/libs/materialize/0.97.7/js/materialize.min.js"></script>
