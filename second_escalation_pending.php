...
<option value="2nd" selected>2nd Escalation Pending</option>
...
<input type="hidden" id="min" value=84 /><br>
<input type="hidden" id="max" value=120/>
<input type="hidden" id="minh" value=7/><br>
<input type="hidden" id="maxh" value=24/>
<input type="hidden" id="minc" value=1/><br>
<input type="hidden" id="maxc" value=2/>';
...
//{			
			...
			<th>Create Time</th><th>Priority</th><th>Time Remaining</th><th>SLA Breached Time</th><th>Actual Age</th><th>Total Age </th><th>Adjustments</th><th>Actual Age(hrs)</th>
