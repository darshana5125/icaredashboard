              ...
              substring_index(substring_index((select name as name
                  ...
                  on h.ticket_id=ti.id  
                    ...
                    inner join users u1 on t.responsible_user_id=u1.id
                      ...
                      and t.customer_id not in($cx_list) and t.queue_id not in($q_list) and t.create_time>='2018-02-01'
                      group by ser_id
                      order by count desc";
    ...
    $query_current_ibl="select count(th.ticket_id) as count,substring_index(substring_index((select name as name
                          ...
                          from ticket_history
                            ...
                            and date(x.change_time) <=  ".$date." and date(x.change_time) >= '2018-02-01' 
                                        ...
                                        t.customer_id not in($cx_list) and t.queue_id not in($q_list)
...
<header>
  ...
  <form name="hod" method="POST" action="hod_new.php">
    ...
    Select Date:
        ...
        <span>
		 ...
		 <h4 style=" margin: 0 150 auto;">Ongoing by Product</h4>
    </div>
...
//alert(test2);
 ...
 data.addRows([[hod, count]]);
        ...
        // Set chart options
        var options = {'title':'Ongoing IBL Pending By Product',
                       'width':700,
                       'height':700};
...
//alert(test2);
 ...
 data.addRows([[hod, count]]);
        ...
        // Set chart options
        var options = {'title':'Ongoing Effective CSR By Product',
                       'width':700,
                       'height':700};
